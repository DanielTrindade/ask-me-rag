...
| Artifact Registry | 0,5 GB | política `scripts/artifact-cleanup-policy.json`: mantém a tag `production` e as 3 imagens mais recentes; apaga o resto após 7 dias |
| Secret Manager | 6 versões ativas, 10 mil acessos | só a versão atual de cada secret fica ativa; as antigas são destruídas |
