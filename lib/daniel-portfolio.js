 ...
 * Generated: 2026-08-27T17:42:14.778Z
 */

/**
 * daniel-portfolio theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { danielPortfolioTheme } from './daniel-portfolio';
 *   import './daniel-portfolio.css';
 */
export const danielPortfolioTheme = {
  ...
  tokens: {
    ...
    "--font-family-heading": "var(--font-bricolage), var(--font-geist-sans), -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
    ...
    "--color-background-surface": "light-dark(#FCFBFA, #201F26)",
    "--color-background-body": "light-dark(#F0EFEC, #16151A)",
    "--color-background-card": "light-dark(#FCFBFA, #201F26)",
    "--color-background-popover": "light-dark(#FCFBFA, #282730)",
    "--color-background-muted": "light-dark(#1918170A, #FFFFFF0A)",
    "--color-accent": "light-dark(#14507F, #7FBCF0)",
    "--color-accent-muted": "light-dark(#0063A733, #9FC9FF40)",
    "--color-neutral": "light-dark(#181C221A, #DDE3EC33)",
    "--color-overlay": "light-dark(#181C2266, #181C2299)",
    "--color-overlay-hover": "light-dark(#1918170A, #FFFFFF0A)",
    "--color-overlay-pressed": "light-dark(#19181714, #FFFFFF14)",
    "--color-text-primary": "light-dark(#191817, #E7E5E2)",
    "--color-text-secondary": "light-dark(#5B5854, #A8A5A0)",
    "--color-text-disabled": "light-dark(#A6A29B, #6E6B67)",
    "--color-text-accent": "light-dark(#14507F, #9CCBEE)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #16151A)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#14507F, #7FBCF0)",
    "--color-icon-primary": "light-dark(#191817, #E7E5E2)",
    "--color-icon-secondary": "light-dark(#5B5854, #A8A5A0)",
    "--color-icon-disabled": "light-dark(#A6A29B, #6E6B67)",
    ...
    "--color-border": "light-dark(#1918171A, #F0EFEC1A)",
    "--color-border-emphasized": "light-dark(#D5D2CC, #4A4843)",
    "--color-skeleton": "light-dark(#DEDBD5, #3A383F)",
    "--color-shadow": "light-dark(rgba(25, 24, 23, 0.10), rgba(0, 0, 0, 0.34))",
    ...
    "--color-background-blue": "light-dark(#C4DDFB, #7FBCF03D)",
    "--color-border-blue": "light-dark(#14507F, #7FBCF0)",
    "--color-icon-blue": "light-dark(#00458C, #7FBCF0)",
    "--color-text-blue": "light-dark(#00458C, #9CCBEE)",
    ...
    "--color-background-inverted": "light-dark(#191817, #FCFBFA)",
    "--color-track": "light-dark(#DEDBD5, #3A383F)",
