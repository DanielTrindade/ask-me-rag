...
function gradedGroundingRules(missingEvidence: string) {
  return [
    ...
    'When connecting facts, cite the concrete projects, technologies, responsibilities, and',
    'results from the sources. Do not add generic claims about benefits, abilities, or best',
    'practices (for example "a complete view of software architecture" or "more scalable',
    'solutions") unless the sources state them.',
